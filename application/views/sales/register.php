...
<div id="register_wrapper">
	...
	<table class="sales_table_100" id="register">
		<thead>
			<tr>
				<th style="width: 40%;"><?php echo $this->lang->line('sales_item_name'); ?></th>
				...
				<th colspan="2" style="width: 5%; ">Actions<?php //echo $this->lang->line('sales_update'); ?></th>
			</tr>
		</thead>
		...
		<tbody id="cart_contents">
			...
			else
			{
				...
				foreach(array_reverse($cart, TRUE) as $line=>$item)
				{
                    ...
                    $grand_subtotal = $grand_subtotal + $subtotal_price;
			?>
						...
						<tr>
							...
							?>
								<td style="align: left;">
									...
									<br/>
									<?php echo implode(' ', array($item['attribute_values'], $item['attribute_dtvalues'])); ?> 
								</td>
							<?php
							}
							?>
							...
							<td>
								...
								{
									echo form_input(array('name'=>'quantity', 'type'=>'number', 'class'=>'form-control input-sm', 'value'=>to_quantity_decimals($item['quantity']), 'min'=>'1', 'tabindex'=>++$tabindex, 'onClick'=>'this.select();'));
								}
								?>
							</td>

							<td>
							    <?php if($this->Employee->has_grant('sales_discount', $this->session->userdata('person_id')))
                				{
                				?>
								...
								<?php } else { 
									...
									echo form_hidden('discount', to_quantity_decimals($item['discount']));
								 } 
								 ?>
							</td>
...
<div id="overall_sale" class="panel panel-default" style="margin-left: .5em;">
	<div class="panel-body">
		...
		<table class="sales_table_100" id="sale_totals">
			...
			<tr>
				<th style="width: 55%;">Sub Total before discounts:</th>
				<th style="width: 45%; text-align: right;"><?php echo to_currency($grand_subtotal); ?></th>
			</tr>
			<tr>
				<th style="width: 55%;">Sub Total after discounts:</th>
				<th style="width: 45%; text-align: right;"><?php echo to_currency($subtotal); ?></th>
			</tr>
			<tr>
				<th style="width: 55%;">Bank Charges 1.5% on Card:</th>
				<th style="width: 45%; text-align: right;"><?php echo to_currency($additional_charges); ?></th>
			</tr>
