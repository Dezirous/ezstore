	...
	<div class="tab-content">
		...
		<div class="tab-pane" id="employee_login_info">
			<fieldset>
				...
				<div class="form-group form-group-sm">
					<?php echo form_label('User Role', 'role', array('class' => 'control-label col-xs-3')); ?>
					<div class='col-xs-8'>
						<div class="input-group">
							<?php
							$roles = array('Admin' => 'Admin', 'Cashier' => 'Cashier', 'Supervisor' => 'Supervisor', 'Owner' => 'Owner', 'POS' => 'POS', 'Purchaser' => 'Purchaser', 'Investor' => 'Investor');
							echo form_dropdown(
								'role',
								$roles,
								$person_info->role,
				...
				<div class="form-group form-group-sm">
					<?php echo form_label('Branch', 'user_location_id', array('class' => 'control-label col-xs-3')); ?>
					<div class='col-xs-8'>
						<div class="input-group">
							<?php
							$locations = array(0 => 'All', 1 => 'Maskan Branch', 3 => 'Johar Branch', 6 => 'Patel Branch', 2 => 'Warehouse');
							echo form_dropdown(
								'user_location_id',
								$locations,
								$person_info->user_location_id,
								array('class' => 'form-control input-sm')
							);
							?>
						</div>
