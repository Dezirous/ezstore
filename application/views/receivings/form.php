...
<?php echo form_open("receivings/save/".$receiving_info['receiving_id'], array('id'=>'receivings_edit_form', 'class'=>'form-horizontal')); ?>
	<fieldset id="receiving_basic_info">
		...
		<div class="form-group form-group-sm">
			<?php echo form_label('Status', 'status', array('class'=>'control-label col-xs-3')); ?>
			<div class='col-xs-8'>
				<?php echo form_input(array('name' => 'status', 'value' => $status, 'id' => 'status', 'class'=>'form-control input-sm'));?>
			</div>
		</div>
