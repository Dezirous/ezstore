...
<ul class="nav nav-tabs nav-justified" data-tabs="tabs">
    <li class="active" role="presentation">
        <a data-toggle="tab"
            href="#customer_basic_info"><?php echo $this->lang->line("customers_basic_information"); ?></a>
    </li>
    <?php
    if (!empty($stats)) {
        ?>
    ...
    if (!empty($mailchimp_info) && !empty($mailchimp_activity)) {
        ...
        <li role="presentation">
            <a data-toggle="tab"
                href="#customer_mailchimp_info"><?php echo $this->lang->line("customers_mailchimp_info"); ?></a>
        </li>
        <?php
    }
    ?>
...
<div class="tab-content">
    <div class="tab-pane fade in active" id="customer_basic_info">
        <fieldset>
            <div class="form-group form-group-sm" <?php echo ($employee_role === 'POS' ? "style='display:none'" : ""); ?>>
            ...
            <div style="<?php echo ($employee_role === 'POS' ? "display:none" : ""); ?>">
