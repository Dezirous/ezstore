...
class Config extends Secure_Controller
{
	...
	/*
	 * This function loads all the licenses starting with the first one being EZStore one
	 */
	private function _licenses()
	{
		...
		$license[$i]['title'] = 'EZStore ' . $this->config->item('application_version');
		...
		{
			$license[$i]['text'] = 'LICENSE file must be in EZStore license directory. You are not allowed to use EZStore application until the distribution copy of LICENSE file is present.';
		}
	...
	public function save_general()
	{
		...
		{
			$definition_data['definition_name'] = 'EZStore_category';
	...
	public function backup_db()
	{
		...
		if($this->Employee->has_module_grant('config', $employee_id))
		{
			...
			$prefs = array(
				'format' => 'zip',
				'filename' => 'EZStore.sql'
			);

			$backup = $this->dbutil->backup($prefs);

			$file_name = 'EZStore-' . date("Y-m-d-H-i-s") .'.zip';
