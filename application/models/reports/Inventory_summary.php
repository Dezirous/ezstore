...
class Inventory_summary extends Report
{
    ...
    {
        $this->db->select('items.*, item_quantities.quantity, (item_quantities.quantity * items.qty_per_pack) as low_sell_quantity,  stock_locations.location_name, (items.cost_price * item_quantities.quantity) AS sub_total_value');
